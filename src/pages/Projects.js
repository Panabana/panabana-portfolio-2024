      ...
      <div className="flex-grow text-neutral-200 bg-slate-800 py-8 sm:py-10">
        <div id="projects" className="container mx-auto min-h-dvh justify-center body-font">
          <div className="container px-5 mx-auto text-center lg:px-40">
            <div>
              <h2 className="sm:text-xl text-xs mt-5">
              ...
              <h3 className="p-2 sm:text-base text-xs mb-6">
                Thank you for looking through my website.
              </h3>
            </div>
            <div className="font-medium font-mono text-[1.25rem] md:text-[3rem] p-4 mt-32">
              <h3>
                My projects:
              </h3>
            </div>
            <div className="grid grid-rows-2 grid-cols-1 ">
              <div className="container mx-auto place-content-center">
                <p className="sm:text-xl text-xs font-medium p-6 italic">
                  The Inventory Management System
                </p>
                <p className="sm:text-base text-xs font-normal p-4">
                  Two different frontend apps connected to the same backend database.
                  <br />
                  <a
              ...
              <div>
                <p className="sm:text-xl text-xs font-medium italic mt-28 p-6">
                  Personal Website
                </p>
                <a
